    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-[#47216b] mb-4">System Not Found</h1>
          <p className="text-xl text-gray-600 mb-6">The growth system you're looking for doesn't exist.</p>
          <Link
            to="/services/dba"
                ...
                >
                  <div className="sticky top-8">
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#47216b] to-[#8344c5]">
                        Building
                      </span> Systems That Scale
                    </h2>

                    <div className="prose prose-lg max-w-none mb-12">
                      <p className="text-xl text-gray-700 leading-relaxed mb-6">
                        Our Systems Architecture Team deploys integrated growth infrastructure that connects your strategy, technology, and data. We build unified ecosystems covering acquisition, retention, operations, and analytics.
                      </p>

                      <p className="text-xl text-gray-700 leading-relaxed">
                        Every component is designed for 10x scale capacity without proportional complexity — systems that grow with you.
                      </p>
                    </div>
                      ...
                      {whyChooseUs.slice(0, 3).map((item, index) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 leading-relaxed">Our proven expertise delivers measurable efficiency gains and revenue impact through integrated systems.</p>
                          </div>
                        </motion.div>
                      ))}
                    </div>
                ...
                >
                  <div className="sticky top-8">
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-md p-8">
                      <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">System Components</h3>
              ...
              >
                ...
                >
                  <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[#47216b] mb-8 leading-tight">
                    Ready to <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#47216b] to-[#8344c5]">Scale</span> Your Business?
                  </h2>
                </motion.div>
                ...
                >
                  Let's discuss how our {title} can help you build infrastructure for 10x growth.
                </motion.p>
