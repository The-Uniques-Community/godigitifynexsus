    ...
    if (openCategory) {
      const getCategoryDetails = async () => {
        ...
        try {
          ...
          console.warn(
            `Failed to fetch details for ${openCategory}, using fallback:`,
            err
          );
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      >
        <Link
          to="/contact"
          className="flex items-center justify-center w-14 h-14 bg-[#47216b] text-white rounded-full shadow-lg hover:bg-[#38134f] hover:shadow-xl transition-all duration-300 transform "
        >
          <svg
            className="w-6 h-6"
            fill="none"
                        ...
                        >
                          ...
                          <div className="flex-grow">
                            ...
                            <p className="text-sm text-gray-600">
                              {category.shortDesc?.substring(0, 60) || ""}...
                            </p>
                          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-10">
            {["overview", "strategy", "design", "technology", "analytics"].map(
              (tab) => (
                <button
                  key={tab}
                      ...
                      >
                        <div className="p-6 md:p-8">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                            {(defaultCategoryStats[category.slug] || []).map(
                              (stat, idx) => (
                                <motion.div
                                  key={idx}
                                  initial={{ opacity: 0, y: 20 }}
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-10">
                            ...
                            <div className="lg:col-span-2 bg-gradient-to-br from-[#47216b]/5 to-[#8344c5]/5 rounded-xl p-6">
                              <h4 className="text-xl font-semibold text-[#47216b] mb-4">
                                Key Benefits
                              </h4>
                              <ul className="space-y-3">
                          ...
                          <div className="mb-10">
                            ...
                            >
                              {serviceOfferings[category.slug]?.map(
                                (service, idx) => (
                                  <motion.div
                                    key={service.id}
                                    variants={{
                                    ...
                                    <div className="relative z-10 p-6">
                                      <div className="flex items-center mb-4">
                                        <div className="w-12 h-12 rounded-lg bg-[#47216b]/10 group-hover:bg-white/10 flex items-center justify-center transition-colors duration-300">
                                          <svg
                                            className="w-6 h-6 text-[#47216b] group-hover:text-white transition-colors duration-300"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                                          >
                                            ...
                                            {idx % 5 === 4 && (
                                              <path
                                                ...
                                                strokeLinejoin="round"
                                                strokeWidth={2}
                                                d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2h2a2 2 0 002-2z"
                                              />
                                            )}
                                          </svg>
                                        </div>
                                      ...
                                      <h5 className="text-lg font-semibold mb-3 text-gray-900 group-hover:text-white transition-colors duration-300">
                                        {service.title}
                                      </h5>
                                ...
                                {[
                                  ...
                                  >
                                    ...
                                    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md border border-gray-100 transition-all duration-300 w-full">
                                      <h5 className="text-lg font-semibold mb-2 text-[#47216b]">
                                        {step}
                                      </h5>
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Beyond our core offerings, we create tailored solutions for
                  your unique business challenges. Our team combines technical
                  expertise, creative thinking, and deep industry knowledge to
                  develop custom implementations that drive tangible results.
                </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Connect your systems and streamline operations with custom integration solutions.",
                    },
                    {
                      title: "Bespoke Data Analytics",
                      description:
                        "Tailored dashboards and reporting solutions to give you actionable insights.",
                    },
                    {
                ...
                >
                  <Link 
                    to="/contact"
                    className="mt-8 px-8 py-4 bg-[#47216b] text-white rounded-full font-semibold shadow-md transition-all duration-300 hover:bg-[#38134f] hover:shadow-lg transform hover:-translate-y-1 inline-flex items-center justify-center"
                  >
                ...
                <div className="relative bg-white p-8 rounded-2xl shadow-xl">
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600 mb-6">
                      Book a 30-minute consultation to discuss your business
                      challenges and how our custom solutions can help.
                    </p>
                  </div>
