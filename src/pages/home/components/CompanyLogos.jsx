  ...
  const companies = [
    {
      id: 1,
      name: "Company 1",
      logo: "https://via.placeholder.com/120x60/cccccc/666666?text=Logo+1"
    },
    {
      id: 2,
      name: "Company 2", 
      logo: "https://via.placeholder.com/120x60/cccccc/666666?text=Logo+2"
    },
    {
      id: 3,
      name: "Company 3",
          ...
          {companies.map((company, index) => (
            <div
              ...
              className={`relative group flex items-center justify-center p-4 md:p-6 lg:p-8 transition-all duration-500 ease-out  hover:bg-gray-50 hover:shadow-lg ${
                // Right border for all except last column (and not if it's the 4th item when we have "Your Logo Here" next)
                (index + 1) % 5 !== 0 && !(index === 3 && companies.length === 4) ? 'border-r border-[#47216b]/30' : ''
              }`}
            >
              <img
                src={company.logo}
