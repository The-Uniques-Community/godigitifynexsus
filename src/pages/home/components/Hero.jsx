            ...
            <div className="lg:col-span-4 text-center lg:text-left">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-[#47216b] font-bold leading-tight">
                  Build<span className="font-medium text-black"> your</span>{" "}
                  Brand
                </h1>
                <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed py-4 md:py-6 max-w-none lg:max-w-3xl mx-auto lg:mx-0">
                  From content to code, strategy to execution —{" "}
                  <span className="font-semibold text-[#47216b]">
                    GoDigitfy is your one-stop solution{" "}
                  </span>{" "}
                  creative, tech, and digital marketing partner. We help
                  startups and enterprises unlock scalable growth with
