        ...
        <section className="bg-white py-16 md:py-24 lg:py-32 px-4 md:px-6 lg:px-8 container mx-auto">
            <div className="mx-auto">
                <h2 className="text-4xl md:text-7xl pb-5 font-bold leading-tight mb-4 text-gray-900">
                    <span className="block"><span className="text-[#47216b]">Systems, Not Services</span></span>
                    <div className="flex justify-start items-center mt-2 w-full text-xl md:text-4xl gap-3 font-semibold text-gray-800">Your Digital Growth Partner <div className='w-full max-w-[100px] md:max-w-[400px] flex bg-[#47216b] h-[2px]'></div> </div>
                </h2>
                <p className="text-lg md:text-xl text-gray-700 mb-6 ">
                    We don't run campaigns. We don't build websites in isolation. We don't hand you tactics that require endless internal effort.<br />
                    <span className="font-semibold text-[#47216b]">Godigitify</span> architects <span className="font-semibold text-[#47216b]">integrated digital ecosystems</span> — connecting your brand, technology, automation, and data into one growth-focused system.<br />
                    For established businesses ready to <span className="font-semibold text-[#47216b]">stop hiring for tasks and start investing in infrastructure</span>.
                </p>
                <p className="text-md md:text-lg text-gray-600 mb-8 ">
                    <strong>Who we work with:</strong> Mid-sized companies, scaling enterprises, and growth-focused leadership teams who understand that sustainable expansion requires more than patchwork digital solutions.<br />
                    <strong>What we solve:</strong> Fragmented marketing stacks, manual growth bottlenecks, platform disconnection, and the gap between strategy and execution.
                </p>
                <div className="flex justify-between items-center mb-12">
                    <div className="flex gap-4">
                        ...
                        {/* <Link to="#" target='_blank' className="text-gray-500 hover:text-[#47216b] transition">
                        ...
                        <Link to="https://www.linkedin.com/company/Godigitifynexus/" target='_blank' className="text-gray-500 hover:text-[#47216b] transition">
                    ...
                    <div>
                        <Link to="/about" className="bg-[#47216b] text-white px-8 py-4 rounded-full font-semibold shadow hover:bg-black transition">
                            Our Approach
                        </Link>
                    </div>
                </div>
